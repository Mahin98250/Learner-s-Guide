  ...
  const features = [
    {
      ...
      desc: 'Clean, organized notes for every class and subject.',
    },
    {
      icon: '📝',
      title: 'Question Bank',
      desc: 'Practice important questions, exercises, and PYQs.',
    },
    {
      icon: '📄',
      title: 'PDF Resources',
      desc: 'Access study PDFs, worksheets, and downloadable material.',
    },
    {
      icon: '🎯',
      title: 'Fast Learning',
      desc: 'Study in a simple, mobile-friendly, and modern way.',
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 py-16 md:py-24">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div className="text-center lg:text-left">
              ...
              <p className="mx-auto mt-5 max-w-xl text-lg text-blue-100 lg:mx-0 md:text-xl">
                Notes, PDFs, Question Banks, Worksheets and smart learning resources
                for Classes 7 to 12.
              </p>
              ...
              <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:justify-center lg:justify-start">
                <Link
                  to="/student/home"
                  className="rounded-2xl bg-white px-8 py-4 text-center font-bold text-blue-700 shadow-xl transition hover:scale-105"
                >
                  Student Portal
                </Link>
                ...
                <Link
                  to="/admin/login"
                  className="rounded-2xl border border-white/20 bg-white/10 px-8 py-4 text-center font-bold backdrop-blur transition hover:scale-105 hover:bg-white/15"
                >
                  Admin Portal
                </Link>
              </div>
              ...
              <div className="mt-8">
                <input
                  placeholder="Search classes, subjects, notes..."
                  className="w-full max-w-md rounded-2xl border border-white/20 bg-white/10 px-5 py-4 text-white placeholder:text-blue-100 outline-none backdrop-blur"
                />
              </div>
            </div>
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="w-full max-w-md rounded-[2rem] border border-white/20 bg-white/10 p-8 shadow-2xl backdrop-blur">
                ...
                <div className="mt-6 grid gap-3 sm:grid-cols-2">
                  <div className="rounded-2xl bg-white px-4 py-4 text-slate-900 shadow-lg">
                    <p className="text-sm font-semibold text-blue-700">Quick access</p>
                    <p className="mt-1 text-sm text-slate-600">
                      Open classes, notes, and materials fast.
                    </p>
                  </div>
                  <div className="rounded-2xl bg-white px-4 py-4 text-slate-900 shadow-lg">
                    <p className="text-sm font-semibold text-blue-700">Mobile ready</p>
                    <p className="mt-1 text-sm text-slate-600">
                      Clean layout on phones and desktops.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        <div className="mb-10 text-center">
          ...
          <p className="mt-3 text-slate-500">
            Everything designed for a smooth learning experience
          </p>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-10">
        <div className="mb-10 text-center">
          <h2 className="text-4xl font-bold">Browse Classes</h2>
          <p className="mt-3 text-slate-500">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {classes.map((cls, index) => (
            <Link
              ...
              className="group relative overflow-hidden rounded-3xl bg-white p-8 shadow-lg transition hover:-translate-y-2 hover:shadow-2xl"
            >
              <div className="absolute right-0 top-0 h-24 w-24 rounded-bl-full bg-gradient-to-br from-blue-100 to-indigo-100 opacity-80 transition group-hover:scale-110" />
              ...
              <div className="relative">
                ...
                <h3 className="text-2xl font-bold">Class {cls}</h3>
      ...
      <section className="bg-white py-16">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-10 text-center">
            <h2 className="text-4xl font-bold text-blue-700">Platform Overview</h2>
            <p className="mt-3 text-slate-500">A quick look at what the platform offers</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-6 md:grid-cols-4">
            {stats.map((stat) => (
              ...
              >
                <h3 className="text-5xl font-black text-blue-700">{stat.value}</h3>
      ...
      {/* CTA */}
      <section className="bg-gradient-to-r from-blue-700 to-indigo-700 py-20 text-center text-white">
        <div className="mx-auto max-w-3xl px-6">
          <h2 className="text-4xl font-black md:text-5xl">
            Ready to Start Learning?
          </h2>
          <p className="mt-4 text-blue-100">
            Access all your study materials in one place with a clean and modern experience.
          </p>
          ...
          <div className="mt-8 flex flex-col justify-center gap-4 sm:flex-row">
            ...
            <Link
              to="/admin/login"
              className="rounded-2xl border border-white/20 bg-white/10 px-8 py-4 font-bold backdrop-blur transition hover:scale-105 hover:bg-white/15"
            >
              Admin Login
            </Link>
          </div>
      ...
      <footer className="bg-slate-900 py-10 text-center text-slate-400">
        © 2026 Learner&apos;s Guide • Built by Mahin
      </footer>
    </div>
  )
}
